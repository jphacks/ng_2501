...
class GeneratedScene(Scene):
    def construct(self):
        ...
        def triangle_with_interior_right_mark() -> VGroup:
            ...
            A12 = E + s*u_EO + s*u_EP
            corner = VGroup(Line(A1, A12, color=WHITE, stroke_width=2),
        ...
        def update_values_panel(d: int):
            ...
            self.play(TransformMatchingTex(cos_val_tex, new_cos),
                      TransformMatchingTex(sin_val_tex, new_sin), run_time=0.25)
